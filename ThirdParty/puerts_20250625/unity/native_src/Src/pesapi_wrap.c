...
PESAPI_MODULE_EXPORT pesapi_value pesapi_create_boolean(struct pesapi_ffi* apis, pesapi_env env, bool value)
{
...
PESAPI_MODULE_EXPORT bool pesapi_get_value_bool(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value)
{
...
PESAPI_MODULE_EXPORT bool pesapi_is_null(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value)
{
    return apis->is_null(env, value);
}

PESAPI_MODULE_EXPORT bool pesapi_is_undefined(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value)
{
    return apis->is_undefined(env, value);
}

PESAPI_MODULE_EXPORT bool pesapi_is_boolean(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value)
{
    return apis->is_boolean(env, value);
}

PESAPI_MODULE_EXPORT bool pesapi_is_int32(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value)
{
    return apis->is_int32(env, value);
}

PESAPI_MODULE_EXPORT bool pesapi_is_uint32(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value)
{
    return apis->is_uint32(env, value);
}

PESAPI_MODULE_EXPORT bool pesapi_is_int64(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value)
{
    return apis->is_int64(env, value);
}

PESAPI_MODULE_EXPORT bool pesapi_is_uint64(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value)
{
    return apis->is_uint64(env, value);
}

PESAPI_MODULE_EXPORT bool pesapi_is_double(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value)
{
    return apis->is_double(env, value);
}

PESAPI_MODULE_EXPORT bool pesapi_is_string(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value)
{
    return apis->is_string(env, value);
}

PESAPI_MODULE_EXPORT bool pesapi_is_object(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value)
{
    return apis->is_object(env, value);
}

PESAPI_MODULE_EXPORT bool pesapi_is_function(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value)
{
    return apis->is_function(env, value);
}

PESAPI_MODULE_EXPORT bool pesapi_is_binary(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value)
{
    return apis->is_binary(env, value);
}

PESAPI_MODULE_EXPORT bool pesapi_is_array(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value)
{
    return apis->is_array(env, value);
}

PESAPI_MODULE_EXPORT pesapi_value pesapi_native_object_to_value(struct pesapi_ffi* apis, pesapi_env env, const void* type_id, void* object_ptr, bool call_finalize)
{
...
PESAPI_MODULE_EXPORT bool pesapi_is_instance_of(struct pesapi_ffi* apis, pesapi_env env, const void* type_id, pesapi_value value)
{
...
PESAPI_MODULE_EXPORT bool pesapi_is_boxed_value(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value)
{
...
PESAPI_MODULE_EXPORT bool pesapi_env_ref_is_valid(struct pesapi_ffi* apis, pesapi_env_ref env)
{
...
PESAPI_MODULE_EXPORT bool pesapi_set_owner(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value, pesapi_value owner)
{
...
PESAPI_MODULE_EXPORT bool pesapi_get_private(struct pesapi_ffi* apis, pesapi_env env, pesapi_value object, void** out_ptr)
{
    return apis->get_private(env, object, out_ptr);
}

PESAPI_MODULE_EXPORT bool pesapi_set_private(struct pesapi_ffi* apis, pesapi_env env, pesapi_value object, void* ptr)
{
